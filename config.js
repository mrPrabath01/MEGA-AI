...
const ownervb = process.env.OWNERS || process.env.OWNER_NUMBER || '94770584736' ; // put your number here
...
global.SESSION_ID = process.env.SESSION_ID || 'aAZChaBB#AquwDKrLqcEperXaRZIz387a0VNW97Hv9vm9C5O6IhM' ;  // put your session id here
